    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Modal Card */}
          <div
            className={`relative w-full max-w-md bg-m3-surface dark:bg-m3-surface-dark rounded-[2.5rem] p-8 md:p-10 border border-m3-surface-high dark:border-m3-surface-high-dark transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
              isClosing ? "animate-modal-exit scale-95" : "animate-modal-enter scale-100"
            }`}
          ...
          >
            ...
            <button
              type="button"
              onClick={closeModal}
              className="absolute top-6 right-6 flex items-center justify-center p-2 bg-m3-surface-container dark:bg-m3-surface-high-dark hover:bg-m3-surface-high dark:hover:bg-m3-surface-container-dark text-gray-900 dark:text-white rounded-full transition-colors duration-200"
            >
            ...
            <form onSubmit={handleEmailLogin} className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-m3-primary dark:text-m3-primary-dark uppercase tracking-wider mb-2">
                  Email
                </label>
                <input
                  type="email"
                  ...
                  className="w-full bg-m3-surface-container dark:bg-m3-surface-container-dark text-gray-900 dark:text-white px-5 py-3.5 rounded-[1.5rem] text-base focus:outline-none focus:ring-2 focus:ring-m3-primary dark:focus:ring-m3-primary-dark transition-all duration-300 placeholder-gray-500"
            ...
            <div className="flex items-center my-6">
              <div className="flex-1 border-t border-gray-200 dark:border-m3-surface-container-dark" />
